...
% 柱状图辅助：\Bar{中心x}{高度(秒)}{颜色}  —— 画柱 + 顶部数值
\newcommand{\Bar}[3]{%
  \fill[#3] (#1-0.6,0) rectangle (#1+0.6,#2);
  \node[above,font=\scriptsize] at (#1,#2) {#2};
}
...
\foreach \v in {0,100,...,600}{
  \draw[gray!30] (0,\v) -- (10.5,\v);
  \node[left,font=\scriptsize] at (0,\v) {\v};
}
\draw[->,thick] (0,0) -- (10.5,0);
\Bar{1.5}{205.9}{cDijkstra}
\Bar{4.0}{255.5}{cAstar}
\Bar{6.5}{476.1}{cACO}
\Bar{9.0}{125.3}{cRLACO}
\node[below,font=\scriptsize] at (1.5,-0.4) {Dijkstra};
\node[below,font=\scriptsize] at (4.0,-0.4) {A*};
\node[below,font=\scriptsize] at (6.5,-0.4) {ACO};
\node[below,font=\scriptsize] at (9.0,-0.4) {RL-ACO};
\node[rotate=90,font=\scriptsize] at (-1.1,2.4) {T95 (s)};
\end{tikzpicture}
...
\begin{tikzpicture}[y=0.008cm]
\foreach \v in {0,100,...,600}{
  \draw[gray!30] (0,\v) -- (12.6,\v);
  \node[left,font=\scriptsize] at (0,\v) {\v};
}
\draw[->,thick] (0,0) -- (12.6,0);
\Bar{1.4}{231.1}{cNone}
\Bar{4.0}{255.5}{cAstar}
\Bar{6.6}{228.5}{cFixed}
\Bar{9.2}{182.2}{cRandom}
\Bar{11.8}{125.3}{cRLACO}
\node[below,font=\scriptsize] at (1.4,-0.4) {A* none};
\node[below,font=\scriptsize] at (4.0,-0.4) {A*+signs};
\node[below,font=\scriptsize] at (6.6,-0.4) {A*+fixed};
\node[below,font=\scriptsize] at (9.2,-0.4) {A*+random};
\node[below,font=\scriptsize] at (11.8,-0.4) {RL-ACO};
\node[rotate=90,font=\scriptsize] at (-1.1,2.4) {T95 (s)};
\end{tikzpicture}
